...
abstract class TokenAssetsState {}

class TokenAssetsInitialSt extends TokenAssetsState {
  final List<TokenAsset> initialTokens;

  TokenAssetsInitialSt()
      : initialTokens = [
          TokenAsset(
              symbol: 'BTC',
...
class UpdatingTokenAssetPricesSt extends TokenAssetsState {
  final String symbol;
  UpdatingTokenAssetPricesSt(this.symbol);
}

class UpdatedTokenAssetPricesSt extends TokenAssetsState {
  // final List<TokenAsset> assets;
  // UpdatedTokenAssetPricesSt(this.assets);
}

class TokenAssetsLoadFailureSt extends TokenAssetsState {
  final String error;

  TokenAssetsLoadFailureSt(this.error);
}
